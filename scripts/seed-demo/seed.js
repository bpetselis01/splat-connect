...
async function phaseA(P) {
  ...
  await toy('bubble', { owner_id: tom.id, name: 'Adapted bubble machine', description: 'Adapted using the guide on here. Needs 4 AA. Comes with a big red switch.', condition: 7, switch_adapted: true, offer_type: 'donation', status: 'published', age_min: 1, age_max: 6, batteries: '4 × AA, not included', switch_fitting: '3.5 mm mono socket', volume: 'Quiet hum', tutorial_id: G.bubble }, ['bubble_photo', 'bubble_photo2'], 0)
  ...
  await toy('spinner', { owner_org_id: northbank, quantity: 3, name: 'Light-up spinning top (adapted)', description: 'Three of these on the club shelf, each with a Light Touch Switch included.', condition: 10, switch_adapted: true, offer_type: 'both', status: 'published', age_min: 2, age_max: 8, batteries: '3 × AAA, included', switch_fitting: '3.5 mm mono socket', volume: 'Silent', tutorial_id: G.lts }, ['lts_photo'], 0)
