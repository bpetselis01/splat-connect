/**
 * Tools sub-resource: add/remove tools on a tutorial the caller owns. Same
 * pattern as parts.ts and stl-files.ts. Unlike parts, tools aren't consumable
 * and users may already own them — hence is_optional and no quantity.
 */
